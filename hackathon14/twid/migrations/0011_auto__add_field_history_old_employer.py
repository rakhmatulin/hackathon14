...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'History.old_employer'
        db.add_column(u'twid_history', 'old_employer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='old_employers', null=True, blank=True, to=orm['twid.Employer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'History.old_employer'
        db.delete_column(u'twid_history', 'old_employer_id')
