...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.employer'
        db.add_column(u'twid_device', 'employer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twid.Employer'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.employer'
        db.delete_column(u'twid_device', 'employer_id')
