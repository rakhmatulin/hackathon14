...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeviceUpdateEmployer'
        db.create_table(u'twid_deviceupdateemployer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('update_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twid.DeviceUpdateRequest'])),
            ('employer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twid.Employer'])),
        ))
        db.send_create_signal(u'twid', ['DeviceUpdateEmployer'])


    def backwards(self, orm):
        # Deleting model 'DeviceUpdateEmployer'
        db.delete_table(u'twid_deviceupdateemployer')
    ...
    models = {
        ...
        u'twid.deviceupdateemployer': {
            'Meta': {'object_name': 'DeviceUpdateEmployer'},
            'employer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['twid.Employer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'update_request': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['twid.DeviceUpdateRequest']"})
        },
        ...
        u'twid.employer': {
            ...
            'user_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'employer'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'twid.history': {
