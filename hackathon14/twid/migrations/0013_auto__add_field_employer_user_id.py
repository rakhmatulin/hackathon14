...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employer.user_id'
        db.add_column(u'twid_employer', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='employer', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employer.user_id'
        db.delete_column(u'twid_employer', 'user_id_id')
